...
CREATE TABLE `supervisor_student` (
  ...
  CONSTRAINT `supervisor_student_ibfk_1` FOREIGN KEY (`supervisor_id`) REFERENCES `supervisors` (`supervisor_id`),
  CONSTRAINT `supervisor_student_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`)
