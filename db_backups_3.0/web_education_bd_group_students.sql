...
CREATE TABLE `group_students` (
  ...
  CONSTRAINT `group_students_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `study_groups` (`study_group_id`) ON DELETE CASCADE,
...
INSERT INTO `group_students` VALUES (1,1),(2,2),(3,3),(1,4),(2,5),(3,6),(1,7),(2,8),(3,9),(1,10),(2,11),(3,12),(1,13),(2,14),(3,15),(1,16),(2,17),(3,18),(1,19),(2,20),(10,21),(17,25),(15,26);
