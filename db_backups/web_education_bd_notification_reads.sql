...
CREATE TABLE `notification_reads` (
  ...
  PRIMARY KEY (`notification_id`,`student_id`,`supervisor_id`),
  ...
  CONSTRAINT `notification_reads_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`) ON DELETE CASCADE,
  CONSTRAINT `notification_reads_ibfk_3` FOREIGN KEY (`supervisor_id`) REFERENCES `supervisors` (`supervisor_id`) ON DELETE CASCADE
